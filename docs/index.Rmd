...
## [Materiais de estudo](https://github.com/beatrizmilz/materiais_estudo_R)
...
---
**Carregando a nossa base**: Vamos usar a base diamonds que já vem no pacote do ggplot2
...
**Quais aspectos visuais utilizar para cada geom_ ?**
  ...
  * Porém, temos um gif muito bom para isso [link aqui](https://www.yihanwu.ca/post/geoms-and-aesthetic-parameters/):
...
Converta o documento em um  arquivo html.
...
- Você pode fazer apresentações usando R, RMarkdown e KnitR - Use o pacote  [Xaringan](https://github.com/yihui/xaringan). Essa apresentação foi feita com Xaringan! [3o Meetup R-Ladies São Paulo sobre Apresentações no R] (https://beatrizmilz.github.io/apresentacao_RLadies_xaringan/)

- Rmd compila em um formato HTML. Entoã você pode criar páginas html usando essa ferramenta. O pacote **[prettydoc](https://cran.r-project.org/web/packages/prettydoc/vignettes/architect.html)**.


- Pacote bookdown - escrever livros; https://bookdown.org/

- Pacote blogdown - criar páginas na internet; https://bookdown.org/yihui/blogdown/

- Veja a [galeria](https://rmarkdown.rstudio.com/gallery.html), lá tem exemplos do que dá pra fazer com Rmarkdown.
